    ...
    useFrame((state) => {
        ...
        if (meshRef.current) {
            ...
            if (material.uniforms) {
                ...
                material.uniforms.uColor1.value.set(sanitizeHexColor(color1, HERO_GEOMETRIC_FALLBACK_COLOR_1));
                material.uniforms.uColor2.value.set(sanitizeHexColor(color2, HERO_GEOMETRIC_FALLBACK_COLOR_2));
            }
        }
    });
