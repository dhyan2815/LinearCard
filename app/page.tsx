...
export default function Home() {
  ...
  const btnPrimaryClass = "bg-brand-orange text-white font-medium border border-white/10 rounded-xl px-5 py-3 cursor-pointer inline-flex items-center justify-center gap-2 text-sm transition-all hover:bg-brand-orange-hover active:scale-[0.98] shadow-[inset_0_1px_0_rgba(255,255,255,0.2)]";
        ...
        <AnimatePresence mode="wait">
          <motion.main key="landing" initial="hidden" animate="visible" exit="hidden" variants={fadeUp} className="flex-1 max-w-5xl w-full mx-auto px-6 py-20 flex flex-col justify-center min-h-[80vh]">
             <div className="max-w-3xl space-y-8">
               <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-md bg-brand-orange/10 text-brand-orange text-xs font-medium border border-brand-orange/20">
               ...
               <h1 className="text-5xl sm:text-7xl font-semibold text-ink-dark tracking-tight leading-tight">
                 Your wallet.<br/>
                 <span className="text-brand-orange">No apps required.</span>
               </h1>
